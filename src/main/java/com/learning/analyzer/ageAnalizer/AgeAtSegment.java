...
public class AgeAtSegment {
    ...
    public static void checkAgeAtSegments(Passenger passenger, Calendar birthDayFromPassport) {
        for (Segment segment : passenger.getSegmentList()) {
            ...
            double days = Days.daysBetween(passengerBirthday,actualSegmentDate).getDays();
